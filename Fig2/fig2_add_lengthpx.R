...
# Fig.2 utility: Add per-cell Length_px metadata to Seurat objects and filter missing cells
#
# This script:
...
#
# Intended use in the Fig.2 workflow:
#   - after QuPath-based diameter export
#   - before two-pass SCTransform + Harmony integration
#
